...
import entity.MethodJavadocEntity;
...
//        System.out.println("create type entity: " + typeEntity.getQualifiedName());
    ...
    public void save(Session session) {
        ...
        try (var tx = session.beginTransaction()) {
            ...
            System.out.println("total entity number: " + entities.size());
